/**
 * Cashfree adapter — Sprint 9.1 stub. All methods throw
...
export class CashfreeAdapter implements PaymentGatewayPort {
  public readonly code = 'cashfree' as const;
  public readonly featureFlagKey = FeesFeatureFlags.GATEWAY_CASHFREE;
