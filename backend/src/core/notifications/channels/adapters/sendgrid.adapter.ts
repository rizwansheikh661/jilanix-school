/**
 * SendGrid adapter — Sprint 10 stub. `send` throws
...
@Injectable()
export class SendgridAdapter implements CommunicationChannelAdapter {
  public readonly channel = 'EMAIL' as const;
  public readonly providerCode = 'sendgrid' as const;
